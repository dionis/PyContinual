...
class Appr(object):
    ...
    def sup_loss(self,output,pooled_rep,tokens_term_ids, tokens_sentence_ids,targets,t):
    ...
    def ent_id_detection(self,trained_task,tokens_term_ids, tokens_sentence_ids,t,which_type=None):
