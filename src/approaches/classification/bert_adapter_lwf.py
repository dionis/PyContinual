...
class Appr(ApprBase):
    ...
    def __init__(self,model,logger,taskcla, args=None):
        ...
        print('BERT ADAPTER LWF NCL')

        #Analize implementation ON
        #
        # https://github.com/mmasana/FACIL/blob/master/src/approach/lwf.py
        #
        # https://paperswithcode.com/paper/learning-without-forgetting

        #######################################################################
        #
        #  OJOOO MUltitask Framework semtiment clasification
        #
        #
        #  https://github.com/yangheng95/PyABSA
        #  https://pyabsa.readthedocs.io/en/v2/
        #
