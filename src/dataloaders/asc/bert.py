...
datasets = [
    ...
    './dat/absa/RestMex2022/sa/All',
    './dat/absa/RestMex2022Continual/sa/Attractive',
    './dat/absa/RestMex2022Continual/sa/Hotel',
    './dat/absa/RestMex2022Continual/sa/Restaurant'
]
...
domains = [
    ...
    'RestMex2022_All',
    'RestMex2022Continual_Attractive',
    'RestMex2022Continual_Hotel',
    'RestMex2022Continual_Restaurant',
]
...
def get(logger=None, args=None):
    ...
    for t in range(args.ntasks):
        ...
        if 'Bing' in dataset:
            data[t]['name'] = dataset
            if args.baseline == 'derpp' or args.baseline == 'a-gem':
                data[t]['ncla'] = 3
            else:
                data[t]['ncla'] = 2
        ...
        if "TripAdvisor" in dataset:
            ...
            ##if all
            if "All" in dataset:
                trainFile = "RestMext2022.json"
            ##if Attractive
            elif "Attractive" in dataset:
                trainFile = "attractive.json"
            ##if Hotel
            elif "Hotel" in dataset:
                trainFile = "hotel.json"
            ##if Restaurant
        ...
        if "TripAdvisor" in dataset:
            ...
            if args.valset_ratio > 0:  # Split text dataset in valid and test subset
                ...
                valid_examples, eval_examples = random_split(valid_examples,
                                                             (len(valid_examples) - valset_len, valset_len))
            else:
